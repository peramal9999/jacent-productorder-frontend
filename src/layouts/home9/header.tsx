...
const Header: React.FC<HeaderProps> = ({className, variant}) => {
    ...
    return (
        <>
            ...
            >
                <div className={cn(
                    "innerSticky z-20 w-full ",
                )}>
                    <Search
                        searchId="mobile-search"
                        className="topbar-search hidden lg:max-w-[600px] absolute z-30 px-4 md:px-6 top-12 xl:top-1"
                    />
                    <div className="top-bar text-13px  border-b border-black/10 dark:border-black/5">
                        ...
                        <Container variant={'Medium'}>
                            <div className="flex items-center justify-between  py-2 md:py-4">
                                ...
                                <div className={`text-sm  gap-2 lg:flex hidden`}>
                                    ...
                                    <div>
                                        <div className="text-brand-dark ">Hotline Free:</div>
                                ...
                                <div className="flex text-sm space-x-5 xl:space-x-15 lg:max-w-[33%] xl:min-w-[200px]">
                                    <button
                                        type="button"
                                        aria-label="Search Toggle"
                                        onClick={() => openSearch()}
                                        title="Search toggle"
                                        className="outline-none hidden lg:flex"
                                    >
                    ...
                    <div
                        className={cn("hidden navbar  lg:block  ", ' bg-gray-900 ')}>
                        <Container variant={'Medium'}>
                            <div className="flex justify-between items-center">
                                ...
                                <MainMenu
                                    ...
                                    className="flex transition-all duration-200 ease-in-out"
                                    classLink={"text-brand-light dark:text-white "}
                                />
                                {/* End of main menu */}
                                ...
                                <div
                                    className="text-brand-light dark:text-white ms-auto flex items-center xl:min-w-[200px] flex-shrink-0">
                                    <div
            ...
            {toggleAllCategory && (
                <div
                    className="shadow_bkg_show fixed w-full h-full inset-0 bg-black/60  z-40 dbackdrop-blur-xs"
